...
public class CreateNewStaff extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String staffId, password, dateOB, staffName, staffPhone, staffAddress;
		Timestamp staffDOB;
		...
		if(staffId != null && staffName!=null && password!=null && staffPhone!=null && staffAddress!=null && dateOB != null){
		try{
		    ...
		    if(staffBO.addNewStaff(staff)){
				request.setAttribute("message", "Add staff '" + staffId + "' successfully!");
			}
		    else{
		    	request.setAttribute("error", "Add staff '" + staffId + "'  failed!");
		    }
		}catch(Exception e){
			request.setAttribute("error", "Add staff '" + staffId + "' invalid!");
		}
		}
